...
# Mengimpor fungsi koneksi dari file terpisah
from db_connector import create_connection 

class ATMApp:
    # mengatur jendela utama dan mengelola perpindahan halaman
    def __init__(self, master):
        self.master = master
        master.title("Sistem Manajemen ATM Sederhana")
        master.geometry("600x400")
        
        # stuktur grid untuk frame agar menumpuk seperti stack
        ...
        for F in (LoginFrame, NasabahFrame, AdminFrame, RegisterFrame):
            ...
            frame = F(master, self) # Meneruskan master (root) dan controller (self/ATMApp)
            self.frames[page_name] = frame
            frame.grid(row=0, column=0, sticky="nsew") # Menempatkan semua frame di posisi yang sama
    ...
    def show_frame(self, page_name):
        ...
        frame.tkraise() # Mengangkat frame ke depan tumpukan
